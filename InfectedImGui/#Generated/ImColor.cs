...
namespace InfectedImGui
{
    ...
    public unsafe partial struct ImColor
    {
        ...
        [DllImport("InfectedImGui.Native.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "__InlineHelper15", ExactSpelling = true)]
        ...
        [DllImport("InfectedImGui.Native.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "__InlineHelper16", ExactSpelling = true)]
        ...
        [DllImport("InfectedImGui.Native.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "__InlineHelper17", ExactSpelling = true)]
        ...
        [DllImport("InfectedImGui.Native.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "__InlineHelper18", ExactSpelling = true)]
        ...
        [DllImport("InfectedImGui.Native.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "__InlineHelper19", ExactSpelling = true)]
        ...
        private static extern ImVec4* ____ConversionOperator_ImVec4_PInvoke(ImColor* @this, out ImVec4 __returnBuffer);
