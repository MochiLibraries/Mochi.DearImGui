...
public unsafe partial struct ImGuiStorage
{
    ...
    public unsafe bool GetBool(uint key, bool default_val/* = 0 */)
    {
        fixed (ImGuiStorage* @this = &this)
    ...
    public unsafe float GetFloat(uint key, float default_val/* = 0 */)
    {
        fixed (ImGuiStorage* @this = &this)
    ...
    public unsafe bool* GetBoolRef(uint key, bool default_val/* = 0 */)
    {
        fixed (ImGuiStorage* @this = &this)
    ...
    public unsafe float* GetFloatRef(uint key, float default_val/* = 0 */)
    {
        fixed (ImGuiStorage* @this = &this)
